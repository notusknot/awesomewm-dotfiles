...
[[ $- != *i* ]] && return
alias matrix='cmatrix -u 5 -b -C blue'
alias please='sudo'
alias v='sudo vim'
alias c='clear'
alias feh='feh --bg-fill --randomize /home/gabriel/stuff/Wallpapers/*'
alias clock='tty-clock -C 6 -b -c -D -t -n'
alias r='ranger'
alias pacup='sudo pacman -Syu'
alias pac='sudo pacman -S'
alias x5='xrandr --output DP-1 --brightness 0.5'
alias x6='xrandr --output DP-1 --brightness 0.6'
alias x7='xrandr --output DP-1 --brightness 0.7'
alias x8='xrandr --output DP-1 --brightness 0.8'
alias x9='xrandr --output DP-1 --brightness 0.9'
alias x1='xrandr --output DP-1 --brightness 1'
alias red='redshift'

export HISTFILE=/home/gabriel/Desktop/stuff/bash-
export LESSHISFILE=-

#pfetch
#echo UNIX Philosophy: Everyting is bloat. Go live in a yurt or some shit
